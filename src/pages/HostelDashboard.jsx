            ...
            <section className="bg-white dark:bg-gray-900" >
                <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
                    <div className="mr-auto place-self-center lg:col-span-7">
                        ...
                        <p className="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">Feed the Need not the Bin</p>
                    ...
                    <div className="hidden lg:mt-0 lg:col-span-5 lg:flex">
                        ...
                        <img src="./images/volunteerLarge.png" alt="mockup" />
                    </div>
                </div>
            </section>
            ...
            <tr className="bg-white dark:bg-gray-800">
                ...
                <td className="px-6 py-4">
                    50
                        ...
                        <a href="/" className="mt-8 inline-flex items-center text-white bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:focus:ring-primary-900">
                            More Details...
